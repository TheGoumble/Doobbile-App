...
from doobbile_app import app, db, bcrypt, mail
from doobbile_app.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm, RequestResetForm, ResetPasswordForm
...
def send_reset_email(user):
    ...
    msg = Message('Password Reset Request',
                  sender="doobbile@gmail.com", recipients=[user.email])
